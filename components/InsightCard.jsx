  ...
  >
    ...
    <div className='w-full flex justify-between items-center'>
      <div className='flex-1 md:ml-[62px] flex flex-col max-w-[650px]'>
        <h2 className='font-normal lg:text-[36px] text-[26px] text-white'>{title}</h2>
        <p className='font-normal text-secondary-white lg:text-[20px] text-[14px] mt-[16px]'>{subtitle}</p>
      </div>
